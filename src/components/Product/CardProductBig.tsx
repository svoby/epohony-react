    ...
    return (
        <div className="card h-100 bg-100">
            ...
            <div className="d-flex flex-column justify-content-between h-100 px-4 pt-3 pb-4">
                ...
                <button className="btn btn-outline-primary d-inline-flex justify-content-between w-100 mt-3" onClick={() => addToCart({ id: "99", name: "Mockup product", price: 1000, quantity: 1 }, true)}>Vložit do košíku <ArrowRightIcon className="sx-24" /></button>
            </div>
        </div>
    )
}
