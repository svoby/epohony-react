      ...
      <Container>
        ...
        <div>
          ...
          <Link to="/cart/list" className="d-inline-flex align-items-center text-white text-micro ml-1 ml-md-4 hover-secondary" href="./cart.html">
            ...
            <span className="d-none d-md-block"><span className="font-weight-bold d-block">{cart.reduce((prev, current) => { return prev + current.price * current.quantity }, 0)} Kč</span>Košík</span>
          </Link>
